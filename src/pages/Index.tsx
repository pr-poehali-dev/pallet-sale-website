          ...
          <div>
            ...
            <div className="mt-10 space-y-6">
              {[
                ...
                { icon: 'MapPin', t: 'г. Одинцово, ул. Южная, д. 14б', d: 'Режим работы: круглосуточно' },
                { icon: 'MapPin', t: 'г. Вязьма, Смоленская обл., ул. Кронштадтская, 111', d: 'Режим работы: 8:00 – 20:00' },
                { icon: 'RefreshCw', t: 'Приёмка б/у поддонов', d: 'Круглосуточно' },
              ].map((c) => (
