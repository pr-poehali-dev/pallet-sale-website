        ...
        <div className="container py-24 md:py-32 grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="mt-8 text-muted-foreground leading-relaxed">
              «Поддон Про» — производитель деревянной тары с полным циклом изготовления: от распиловки древесины до конечной обработки. Производство расположено в Смоленской области, также работают площадки по продаже б/у поддонов в г. Одинцово Московской области.
          ...
          <div>
            ...
            <div className="mt-10 space-y-6">
              {[
                ...
                { icon: 'MapPin', t: 'г. Одинцово, ул. Южная, д. 14б', d: 'Режим работы: 8:00 – 20:00 · Приёмка б/у поддонов: круглосуточно' },
                { icon: 'MapPin', t: 'г. Вязьма, Смоленская обл., ул. Кронштадтская, 111', d: 'Режим работы: 8:00 – 20:00 · Приёмка б/у поддонов: круглосуточно' },
              ].map((c) => (
